...
const initData = function () {
  ...
  for (const info of props.listData) {
    info.treeId = info.dataType + "--" + info.id
    if (info.dataType === 2) {
...
<template>
  <firDialog name="地质监测" @closeDialog="closeDialog">
