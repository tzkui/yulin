...
<template>
  <firDialog name="安全生产监测" @closeDialog="closeDialog">
    <div class="firDialog_main">
      <div class="list_content">
        <div class="list_header">
          <div class="line1">名称</div>
          <div class="line2">监测单位</div>
          <div class="line2">监测对象</div>
        </div>
        <ul class="list">
          <li
            class="list_item"
          ...
          >
            <div class="line1">{{ item.equipmentName }}</div>
            <div class="line2">{{ item.orgName }}</div>
            <div class="line2">{{ item.surveyObject }}</div>
          </li>
        </ul>
      </div>
    </div>
