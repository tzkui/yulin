export let mapDeafultOps = {
  ...
  basemaps: [
    ...
    {
      name: "layer_2020YXSG_2000_WW新地天地图",
      type: "arcgis_tile",
      show: false,
      url: "http://1.85.55.225:8085/arcgis/rest/services/2020YXSG_2000_WW/MapServer",
      ChinaCRS: "WGS84",
    },
    {
      name: "layer_2020SLSG_2000_WW新的地图",
      type: "arcgis_tile",
      show: false,
      ChinaCRS: "WGS84",
      url: "http://1.85.55.225:8085/YouMapServer/rest/service/2020SLSG_2000_WW/TileServer",
    },
    {
...
export let drawGeoJsonStyle = {
  ...
  mask: {
    ...
    // fillColor: "rgba(22,49,100, 1)", //覆盖面颜色
